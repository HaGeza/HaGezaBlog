...
pub const fn get_semicircle(radius: f32, start_radian: f32, end_radian: f32, num_sections: usize) -> Vec<Vec2> {
    let radian_step =
 ...
 */
pub const fn intersect(line_a: [&Vec2; 2], line_b: [&Vec2; 2]) -> Option<Vec2> {
